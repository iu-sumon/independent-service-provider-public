    ...
    return (
        <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 pt-20 h-screen'>
             <div className='grid grid-cols-2  justify-center md:w-[70%]  m-auto'>
                 <div className='border-2 p-1 rounded-2xl shadow-xl w-[350px] m-auto'>
                     <img className='w-[350px] h-[400px] rounded-2xl' src={photo} alt="" />
                  </div>
                  <div className='border-2 pt-20 text-white shadow-xl p-5 rounded-2xl'>
