...
const Footer = () => {
    return (
        <div>
            <div className="py-20 px-4 bg-gray-700 md:flex md:items-center md:justify-around">
                <span className="text-md text-white sm:text-center">© 2022 <Link to="/">My Doctor</Link>. All Rights Reserved.
                </span>
